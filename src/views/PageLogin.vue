  ...
  <div class="login_wrap">
    ...
    <div class="c-bg">
      <div class="hongbao-top">
        <div class="i-bg">
          <div class="i-bg-b">
            ...
            <!--<div class="download-app" @click="downLoadApp();">-->
            <!--<a>点击下载APP</a>-->
            <!--</div>-->
          </div>
        </div>
      ...
      <div class="footer-conter">
        <div class="title-f">
          <span class="r-line-r"></span>
          <span class="c-top">领取细则</span>
...
<style lang="scss">
  ...
  .login_wrap {
    ...
    .download-app {
      text-align: center;
      color: rgba(255, 67, 35, 1);
      margin-top: 0.4rem;
      a {
        border-bottom: 1px solid rgba(255, 67, 35, 1);
      }
    }
    .el-form-item {
      margin-bottom: 0;
